...
class JuliaMiniTouchUI(octoprint.plugin.StartupPlugin):
	...
	def get_update_information(self):
		return dict(
			JuliaExtended2019TouchUI=dict(
				displayName="JuliaExtended2018TouchUI",
				displayVersion=self._plugin_version,
				# version check: github repository
				type="github_release",
				user="FracktalWorks",
				repo="JuliaExtended2018TouchUI",
				current=self._plugin_version,

				# update method: pip
				pip="https://github.com/FracktalWorks/JuliaExtended2018TouchUI/archive/{target_version}.zip"
			)
		)


__plugin_name__ = "JuliaExtended2018TouchUI"
__plugin_version__ = "1.0.0"


def __plugin_load__():
	global __plugin_implementation__
	__plugin_implementation__ = JuliaExtended2018TouchUI()
